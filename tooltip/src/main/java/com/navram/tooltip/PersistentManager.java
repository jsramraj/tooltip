 ...
 * If an entry is found in the shared preference for a activity name and the resource id,
 * it means that the user has seen/dismissed the tip
 */
public class PersistentManager {

    private static volatile PersistentManager instance;
    ...
    public static PersistentManager getInstance() {
        ...
        PersistentManager localResource = instance;

        if (localResource == null) {
            synchronized (LOCK) {
                localResource = instance;
                if (localResource == null) {
                    instance = localResource = new PersistentManager();
                }
            }
        }
